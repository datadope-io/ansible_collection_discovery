...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.parsers.yaml import YamlParser
...
@pytest.mark.parametrize(
    ...
    (
        ('{"key": "value"', "Cannot parse text into yaml: "),
        ('key:\n  value: \n    - elem1\n    elem2: value2\n', "Cannot parse text into yaml: ")
    )
)
