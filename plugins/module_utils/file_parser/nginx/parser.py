...
class BaseNginxConfigParser(object):
...
#            errorlog=yacc.PlyLogger(sys.stdout),
    ...
    def p_error(self, p):
        ...
        stack_state_str = ' '.join([symbol.type for symbol in self.engine.symstack][1:])
...
def make_parser(**options):
    ...
    parser_class = BaseNginxConfigParser

    parser_class = type(str('NginxConfigParser'),
