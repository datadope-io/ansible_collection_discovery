...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.common.collections import \
    is_iterable
...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.common.text.formatters import \
    lenient_lowercase
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.common.validation import (
...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.common.warnings import \
    warn
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.errors import (
    AliasError,
...
def _validate_sub_spec(argument_spec, parameters, prefix='', options_context=None, errors=None, no_log_values=None,
        ...
        if wanted == 'dict' or (wanted == 'list' and value.get('elements', '') == 'dict'):
            ...
            for idx, sub_parameters in enumerate(elements):
                ...
                unsupported_parameters.update(
                    _get_unsupported_parameters(sub_spec, sub_parameters, legal_inputs, options_context))
                ...
                # Handle nested specs
                _validate_sub_spec(sub_spec, sub_parameters, new_prefix, options_context, errors, no_log_values,
        ...
        if isinstance(new_data, Mapping):
            for old_key, old_elem in old_data.items():
                if old_key in ignore_keys or old_key.startswith('_ansible'):
                    new_data[old_key] = _sanitize_keys_conditions(old_elem, no_log_strings, ignore_keys,
                                                                  deferred_removals)
                else:
                    ...
                    new_data[new_key] = _sanitize_keys_conditions(old_elem, no_log_strings, ignore_keys,
                                                                  deferred_removals)
        else:
