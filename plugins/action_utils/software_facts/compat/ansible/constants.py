...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.config.manager import \
    ConfigManager, ensure_type
...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.parsing.convert_bool import \
    BOOLEANS_TRUE
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.utils.fqcn import \
    add_internal_fqcns
...
DEFAULT_PASSWORD_CHARS = to_text(ascii_letters + digits + ".,:-_",
                                 errors='strict')  # characters included in auto-generated passwords
...
MODULE_REQUIRE_ARGS = tuple(
    add_internal_fqcns(('command', 'win_command', 'ansible.windows.win_command', 'shell', 'win_shell',
