...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible import constants as C
...
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.module_utils.common.text.converters import \
    to_bytes, to_text
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.utils.color import \
    stringc
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.utils.singleton import \
    Singleton
from ansible_collections.datadope.discovery.plugins.action_utils.software_facts.compat.ansible.utils.unsafe_proxy import \
    wrap_var
...
class Display(with_metaclass(Singleton, object)):
    ...
    def deprecated(self, msg, version=None, removed=False, date=None, collection_name=None):
        ...
        message_text = self.get_deprecation_message(msg, version=version, removed=removed, date=date,
